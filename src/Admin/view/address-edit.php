<div class="wrap">
    <h1 class="wp-heading-inline"><?php _e( 'Edit Address', 'boomdevs' );?></h1>

    <?php
        if (isset($_GET['address-updated'])) { ?>
           <div class="notice notice-success">
               <p><?php  _e( 'Address has been updated successfully !', 'boomdevs' ); ?></p>
           </div>
    <?php } ?>
    ...
    <form action="" method="post">
        ...
        <?php submit_button( __( 'Update Address', 'boomdevs' ), 'primary', 'submit_address' );?>
    </form>
</div>